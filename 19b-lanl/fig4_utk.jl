...
PyPlot.plot(xy[fs2,1],xy[fs2,2],"o",color=cols[1],markersize=10.)
PyPlot.plot(xy[fs3,1],xy[fs3,2],"o",color=cols[2],markersize=10.)
PyPlot.plot(xy[fs4,1],xy[fs4,2],"o",color=cols[3],markersize=10.)
axis([-105.,-63.,24.,48.])
PyPlot.xticks([])
PyPlot.yticks([])
...
L0red = nL0[[1:fs4-1;fs4+1:fs3-1;fs3+1:fs1-1;fs1+1:fs2-1;fs2+1:size(nL0)[1]],:]
...
PyPlot.plot(ks/T,-nL0[fs1,:],"-",color=(0.,0.,0.),linewidth=2.,label="$fs1id")
PyPlot.plot(ks/T,-nL0[fs2,:],"-",color=cols[1],linewidth=2.,label="$fs2id")
PyPlot.plot(ks/T,-nL0[fs3,:],"-",color=cols[2],linewidth=2.,label="$fs3id")
PyPlot.plot(ks/T,-nL0[fs4,:],"-",color=cols[3],linewidth=2.,label="$fs4id")
