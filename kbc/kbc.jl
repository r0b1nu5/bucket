...
function kbc_longrun(w0::Array{Float64,1}, Dth::Float64, th0::Array{Float64,1}, max_iter::Int64, eps::Float64=1e-8, h::Float64=.001)
	n = length(th0)
	...
	while err > eps && c < max_iter
		...
		x = mod(th1[1] + pi,2pi) - pi
		y = mod(th2[1] + pi,2pi) - pi
