...
plot_bound(1)
plot_data("data/I_ref_0229_0317.csv",1)

N = 8500000
start_day = 15
n = Int(readdlm("data/I_ref_0229_0317.csv",',')[start_day+1])
...
plot_bound(2)
plot_data("data/I_ref_0229_0317.csv",2)
...
plot_bound(3)
plot_data("data/I_ref_0229_0317.csv",3)
