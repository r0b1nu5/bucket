...
writedlm("data/ranks_updated_rank_$(P0)_rev.csv",ranks2,',')
writedlm("data/rmvd_updated_rank_$(P0)_rev.csv",rmvd2,',')
writedlm("data/cuts_updated_rank_$(P0)_rev.csv",cuts2,',')
