...
writedlm("data/ranks_detadpu_rank_$(P0)_rev.csv",ranks2,',')
writedlm("data/rmvd_detadpu_rank_$(P0)_rev.csv",rmvd2,',')
writedlm("data/cuts_detadpu_rank_$(P0)_rev.csv",cuts2,',')
