...
writedlm("data/ieee57_ranks_tini_rank_$(P0)_rev.csv",ranks1,',')
writedlm("data/ieee57_rmvd_tini_rank_$(P0)_rev.csv",rmvd1,',')
writedlm("data/ieee57_cuts_tini_rank_$(P0)_rev.csv",cuts1,',')
