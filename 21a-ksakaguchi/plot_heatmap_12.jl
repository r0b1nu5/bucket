...
n = 12
A = readdlm("ntw_data/ntw12_A.csv",',')
L = readdlm("ntw_data/ntw12_L.csv",',')
B,w = L2B(L)
R = zeros(n-1,n)
for i in 1:n-1
	for j in 1:i
...
Σ = [[1,2,3,4,5,6,7,1],[7,8,9,10,11,12,1,7]]
...
θ0 = zeros(n)
θ1 = vec(readdlm("ntw_data/ntw12_$(ϕ)_th1.csv",','))
θ2 = vec(readdlm("ntw_data/ntw12_$(ϕ)_th2.csv",','))
