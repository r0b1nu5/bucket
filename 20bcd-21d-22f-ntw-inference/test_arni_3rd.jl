...
ξ = 1e-10
roc11 = roc(adjarni1 .+ ξ*rand(n,n),adj1)
roc12 = roc(adjarni1 .+ ξ*rand(n,n),adj2)
roc13 = roc(adjarni1 .+ ξ*rand(n,n),adj3)
roc21 = roc(adjarni2 .+ ξ*rand(n,n),adj1)
roc22 = roc(adjarni2 .+ ξ*rand(n,n),adj2)
roc23 = roc(adjarni2 .+ ξ*rand(n,n),adj3)
roc31 = roc(adjarni3 .+ ξ*rand(n,n),adj1)
roc32 = roc(adjarni3 .+ ξ*rand(n,n),adj2)
roc33 = roc(adjarni3 .+ ξ*rand(n,n),adj3)
