...
function ntw_inf_sine(th_ij::Float64, t::Int64, n::Int64, a0::Float64, w0::Float64, p0::Float64, h::Float64=.1)
	num = (th_ij - a0/(n*w0)*(1 - cos(w0*h*t + p0)))
	denom = a0*sin(w0*h*t + p0)
