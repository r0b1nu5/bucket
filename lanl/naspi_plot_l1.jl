...
kss = Dict{Tuple{String,Int64},Tuple{Int64,Int64,Int64}}(
							 ...
							 ("mysterious_forcing_PEN2",1) => (5000,6000,50),
							 ("mysterious_forcing_PEN3",1) => (8500,10000,50),
							 ("mysterious_forcing_PEN4",1) => (6000,7000,50),
							 ("mysterious_forcing_PEN5",1) => (5000,6500,50),
							 ("mysterious_forcing_PEN8",1) => (9000,10000,50),
...
ns = Dict{String,Int64}(
			...
			"mysterious_forcing_PEN2" => 129,
			"mysterious_forcing_PEN3" => 130,
			"mysterious_forcing_PEN4" => 129,
			"mysterious_forcing_PEN5" => 130,
			"mysterious_forcing_PEN8" => 134,
			"ntw20_multisine" => 20,
			"ntw20_saw" => 20,
			"ntw20_step" => 20,
			)
...
T = Dict{String,Float64}(
		       ...
		       "mysterious_forcing_PEN2" => 37800/30,
		       "mysterious_forcing_PEN3" => 19800/30,
		       "mysterious_forcing_PEN4" => 18000/30,
		       "mysterious_forcing_PEN5" => 37800/30,
		       "mysterious_forcing_PEN8" => 37800/30,
		       "ntw20_multisine" => 100.,
		       "ntw20_saw" => 100.,
		       "ntw20_step" => 100.,
		       )
