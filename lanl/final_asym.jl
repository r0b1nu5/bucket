...
"""
	run_l0_asym(Xs::Array{Float64,2}, τ::Float64, ls::Array{Int64,1}, ks::Array{Int64,1}, is_laplacian::Bool, plot::Bool=false, b::Float64=0., μ::Float64=1e-1, bp::Float64=1e-1)
...
"""
	run_l1_asym(Xs::Array{Float64,2}, τ::Float64, ks::Array{Int64,1}, is_laplacian::Bool, plot::Bool=false, b::Float64=0., μ::Float64=1e-1, bp::Float64=1e-1)
...
"""
	Lmin_l1_asym(x::Array{Float64,2}, Dx::Array{Float64,2}, xt::Array{Complex{Float64},2}, Dxt::Array{Complex{Float64,2}, k::Int64, A1h::Array{Float64,2}, a2h::Array{Float64,1}, b::Float64=0., μ::Float64=1e-1, bp::Float64=1e-1)
...
# tr((L_{l,:})^T*D_{l,:}*F(k)) = tr((D_{l,:})^T*L_{l,:}*F(k))
	@NLexpression(system_id, AAF2a[l = 1:n], 
		      sum(A1[l,i]*a2[l]*Fk[n+l,i] for i = 1:n))
	@NLexpression(system_id, AAF2a[l = 1:n], 
		      sum(a2[l]*A1[l,j]*Fk[j,n+l] for i = 1:n))
