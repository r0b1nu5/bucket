...
\todo[inline]{Add log-normal distri, parabolic fractal distri, Levy distri, Weibull distri (mostly to discard them);
...
Exonential: light tail, Poisson: light tail, Strechted exponential: light tail,...
