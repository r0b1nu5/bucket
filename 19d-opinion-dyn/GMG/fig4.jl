...
eff_extremist = vec(readdlm("add_data/fig4a-1-6-rm.csv",',') + readdlm("add_data/fig4a-6-6-rm.csv",','))
#eff_moderate = vec(readdlm("add_data/fig4a-moderate.csv",','))
eff_moderate = vec(readdlm("add_data/fig4a-2-6-rm.csv",',') + readdlm("add_data/fig4a-5-6-rm.csv",','))
#eff_centrist = vec(readdlm("add_data/fig4a-centrist.csv",','))
eff_centrist = vec(readdlm("add_data/fig4a-3-6-rm.csv",',') + readdlm("add_data/fig4a-4-6-rm.csv",','))
...
PP6 = 100*readdlm("add_data/fig4b-1st-6-rm.csv",',')'
...
PP6 = 100*readdlm("add_data/fig4b-2nd-6-rm.csv",',')'
sPP6 = zeros(1,length(ϵs))
for i in 1:6
	global sPP6 = [sPP6;sum(PP6[1:i,:],dims=1)]
	PyPlot.fill([ϵs;ϵs[end:-1:1]],[sPP6[i,:];sPP6[i+1,151:-1:1]],color=cmap(i/6))
...
p1 = readdlm("add_data/fig4b-n-1st-pr-wta-sr-6-rm.csv",',')
p2 = readdlm("add_data/fig4b-n-2nd-pr-wta-sr-6-rm.csv",',')
p3 = readdlm("add_data/fig4b-n-3rd-pr-wta-sr-6-rm.csv",',')
